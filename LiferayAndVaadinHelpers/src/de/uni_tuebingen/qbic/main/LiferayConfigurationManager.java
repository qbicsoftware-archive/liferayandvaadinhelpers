...
public enum LiferayConfigurationManager implements ConfigurationManager {
	 Instance;
	  ...
	  /*  private LiferayConfigurationManager(){
	    	init();
	    }*/
...
/*
public class LiferayConfigurationManager implements ConfigurationManager {
    ...
    private static Logger log = new Logger(LiferayConfigurationManager.class);
    private static LiferayConfigurationManager INSTANCE = new LiferayConfigurationManager();
    ...
    public static LiferayConfigurationManager getInstance() {
	return INSTANCE;
    }
